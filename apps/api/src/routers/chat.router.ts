...
chatRouter.put('/chats/:chatId', requireAuth, requireChatMember, validateBody(updateChatSchema), chatController.updateChat)
chatRouter.delete('/chats/:chatId', requireAuth, requireChatAdmin, chatController.deleteChat)

chatRouter.post('/chats/:chatId/members', requireAuth, requireChatMember, validateBody(addChatMemberSchema), chatController.addUserToChat)
